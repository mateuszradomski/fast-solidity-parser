...
//address constant ARB_SYS_ADDRESS = address(100);
...
// address constant DEFAULT_XDOMAIN_MESSAGE_SENDER = address(1);
address constant DEPLOYER_WHITELIST = 0x4200000000000000000000000000000000000002;
// address constant DISABLED = address(1);
...
// address constant EMPTY_ACTIVEOUTBOX = address(type(uint160).max);
// address constant ESTIMATION_ADDRESS = address(1);
...
// address constant SPECIAL_ACCOUNT_ADDRESS = address(0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF);
...
// address constant EMPTY_ACTIVEOUTBOX = address(type(uint160).max);
// address constant SENDER_DEFAULT_CONTEXT = address(type(uint160).max);
